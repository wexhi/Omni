...
typedef enum
{
    ...
    PID_OutputFilter = 0x00010000,                // 0001 0000
    PID_ChangingIntegrationRate = 0x00100000,     // 0010 0000
    PID_DerivativeFilter = 0x01000000,            // 0100 0000
    PID_ErrorHandle = 0x10000000,                 // 1000 0000
} PID_Improvement_e;
